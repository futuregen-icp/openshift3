### OpenShift Container Platform infrastructure component images
**version : v3.11.501**   (latest version v3.11.521)
```
...
```
### For on-premise installations on x86_64 servers
**version : v3.11.501**   (latest version v3.11.521)
```
docker pull registry.redhat.io/openshift3/ose-efs-provisioner:<tag>
```
### OpenShift Container Platform component images for the optional components
**version : v3.11.501**   (latest version v3.11.521)
```
...
```
### Red Hat-certified Source-to-Image (S2I) builder images
```
